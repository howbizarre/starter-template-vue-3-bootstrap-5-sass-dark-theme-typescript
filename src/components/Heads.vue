    ...
    <div class="box p-5 mb-4 rounded-3">
        <div class="container-fluid py-5">
            ...
            <p class="col-md-10 fs-4">
              ...
              Dark theme support in Bootstrap, by default, comes from version 5.3.0, which is currently an Alpha release.
              Therefore, it should be installed explicitly, and you should test it well before adding it to the production environment.
            </p>
        </div>
    </div>
</template>